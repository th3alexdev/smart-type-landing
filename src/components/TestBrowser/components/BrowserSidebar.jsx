...
function BrowserSidebar({ test }) {
  return (
    <>
      {
        test === 1 && (
          <div className='w-1/4 h-full bg-chatgpt-sidebar-pri py-2 px-3'>
      ...
      {
        test === 2 && (
           <div className='w-1/4 bg-ig-sidebar-pri py-2 border-r border-slate-400'>
      ...
      {
        test === 3 && (
          <div className='w-4/12 bg-ig-sidebar-pri py-4 border-r border-slate-200'>
              <div className='w-24 h-10 ml-2 mb-5 bg-mail-sidebar-sec rounded-xl'></div>
              <div className='w-full px-4 flex flex-col gap-4'>
                  <div className='w-20 h-3 mail-sidebar-thi rounded-full'></div>
                  <div className='w-24 h-3 mail-sidebar-thi rounded-full'></div>
                  <div className='w-16 h-3 mail-sidebar-thi rounded-full'></div>
                  <div className='w-22 h-3 mail-sidebar-thi rounded-full'></div>

                  <div className='w-full h-max pl-4 flex gap-2'>
                      <div className='w-4 h-3 mail-sidebar-thi rounded-full'></div>
                      <div className='w-full h-3 mail-sidebar-thi rounded-full'></div>
                  </div>
                  <div className='w-full h-max pl-4 flex gap-2'>
                      <div className='w-4 h-3 mail-sidebar-thi rounded-full'></div>
